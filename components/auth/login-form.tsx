  ...
  if (sent) {
    return (
      <div className="text-center py-4">
        ...
        <h2 className="font-serif text-lg text-stone mb-2">Check your email</h2>
        <p className="text-stone-muted text-sm mb-4">
          We sent a magic link to <span className="text-stone">{email}</span>
        </p>
        <button onClick={() => setSent(false)} className="text-xs text-stone-subtle hover:text-stone transition-colors">
